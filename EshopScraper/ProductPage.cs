...
namespace QuickType.Product
{
    ...
    public partial class CommentForm
    {
        ...
        public IdClass PackageId { get; set; }
    ...
    public partial class Entity
    {
        ...
        public Dictionary<string, ProductVersion> ProductVersion { get; set; }
    ...
    public partial class Category
    {
        ...
        public CategoryId85[] Subs { get; set; }

        [JsonProperty("partners", NullValueHandling = NullValueHandling.Ignore)]
        public CategoryId85[] Partners { get; set; }
        ...
        public CategoryId85[] Path { get; set; }

        [JsonProperty("publishedDate", NullValueHandling = NullValueHandling.Ignore)]
        public DateTimeOffset? PublishedDate { get; set; }
    }

    public partial class CategoryId85
    {
        [JsonProperty("type")]
        public CategoryId85_Type Type { get; set; }
    ...
    public partial class Product
    {
        ...
        public CategoryId85 CurrentVersion { get; set; }
        ...
        public CategoryId85 Publisher { get; set; }
        ...
        [JsonProperty("category")]
        public CategoryId85 Category { get; set; }
    ...
    public partial class Query
    {
        ...
        public CategoryId85[] Categories { get; set; }

        [JsonProperty("feature")]
        public Feature Feature { get; set; }

        [JsonProperty("productETag({\"id\":\"32351\"})")]
        public CategoryId85 ProductETagId32351 { get; set; }

        [JsonProperty("product({\"id\":\"32351\"})")]
        public CategoryId85 ProductId32351 { get; set; }

        [JsonProperty("category({\"id\":\"85\"})")]
        public CategoryId85 CategoryId85 { get; set; }
    }
    ...
    public enum Typename { Category, Product, ProductPublisher, ProductVersion };

    public enum CategoryId85_Type { Id };
    ...
    public partial struct IdElement
    {
        ...
        public static implicit operator IdElement(Typename Enum) => new IdElement { Enum = Enum };
        public static implicit operator IdElement(long Integer) => new IdElement { Integer = Integer };
    }

    public partial class ProductPage
    {
        public static ProductPage FromJson(string json) => JsonConvert.DeserializeObject<ProductPage>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ProductPage self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters = {
                ...
                IdElementConverter.Singleton,
                CategoryId85TypeConverter.Singleton,
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "ProductPublisher":
                    return Typename.ProductPublisher;
                case "ProductVersion":
                    return Typename.ProductVersion;
            }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case Typename.Product:
                    ...
                    return;
                case Typename.ProductPublisher:
                    serializer.Serialize(writer, "ProductPublisher");
                    return;
                case Typename.ProductVersion:
    ...
    internal class IdElementConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(IdElement) || t == typeof(IdElement?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            switch (reader.TokenType)
            {
                ...
                case JsonToken.Date:
                    ...
                    {
                        case "Category":
                            return new IdElement { Enum = Typename.Category };
                        case "Product":
                            return new IdElement { Enum = Typename.Product };
                        case "ProductPublisher":
                            return new IdElement { Enum = Typename.ProductPublisher };
                        case "ProductVersion":
                            return new IdElement { Enum = Typename.ProductVersion };
                    }
                    long l;
                    if (Int64.TryParse(stringValue, out l))
                    {
                        return new IdElement { Integer = l };
                    }
                    break;
            }
            throw new Exception("Cannot unmarshal type IdElement");
        }

        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            var value = (IdElement)untypedValue;
            if (value.Enum != null)
            {
                switch (value.Enum)
                {
            ...
            throw new Exception("Cannot marshal type IdElement");
        }

        public static readonly IdElementConverter Singleton = new IdElementConverter();
    }

    internal class CategoryId85TypeConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(CategoryId85_Type) || t == typeof(CategoryId85_Type?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            if (value == "id")
            {
                return CategoryId85_Type.Id;
            }
            throw new Exception("Cannot unmarshal type CategoryId85_Type");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (CategoryId85_Type)untypedValue;
            if (value == CategoryId85_Type.Id)
            {
                serializer.Serialize(writer, "id");
                return;
            }
            throw new Exception("Cannot marshal type CategoryId85_Type");
        }

        public static readonly CategoryId85TypeConverter Singleton = new CategoryId85TypeConverter();
    }
